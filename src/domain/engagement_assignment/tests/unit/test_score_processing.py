...
from src.domain.engagement_assignment.calculation import score_processor, score_data_service
from src.domain.engagement_assignment.tests.ea_test_data import assignment_1, client_1, \
