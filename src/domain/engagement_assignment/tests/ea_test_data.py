...
from src.domain.client.enums import ClientTypeChoices
from src.domain.client.models import Client
from src.domain.engagement_assignment import constants
from src.domain.engagement_assignment.models import EngagementAssignment
...
client_1_typical_score_data = {
  constants.PROSPECT_TOTAL_COUNT: 1000,
